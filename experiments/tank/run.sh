...
group_one() {
    ...
    python ../../run.py $TRAIN_OR_TEST tank --num-parallel 100000 --horizon 20 --epochs 2000 --mini-epochs 1 --qp-unrolled --shared-PH --affine-qb --mpc-baseline-N 2 --noise-level 0 --batch-test --exp-name qp_unrolled_shared_affine
