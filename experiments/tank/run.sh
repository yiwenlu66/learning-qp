...
python ../../run.py $1 tank --num-parallel 100000 --horizon 20 --epochs 300 --mini-epochs 1 --qp-unrolled --shared-PH --qp-iter 10 --warm-start --exp-name qp_unrolled_shared_ws
